...
import { sign, getPublicKey, poseidonHashMany, type Signature } from '../crypto/index.js';
import type { TypedData, SignatureArray } from './types.js';
...
export class PrivateKeySigner implements SignerInterface {
  ...
  async signMessage(
    ...
    return [toBigInt(signature.r), toBigInt(signature.s)];
  }
