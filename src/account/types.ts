...
import { toBigInt, type Felt252Type, type Felt252Input } from '../primitives/index.js';
 ...
 */
export interface SignedDeployAccountTransactionV3 extends DeployAccountTransactionV3 {
  /** Transaction signature */
  signature: bigint[];
}
...
export function signatureToArray(sig: Signature): SignatureArray {
  return [toBigInt(sig.r), toBigInt(sig.s)];
}
