...
export function webSocketTransport(
  ...
  function handleMessage(data: string): void {
    ...
    if (
      ...
      const subscriptionId =
        params?.subscription_id ?? params?.subscription;
  ...
  const transport: WebSocketTransport = {
    ...
    on<E extends keyof TransportEvents>(
      ...
      eventListeners.get(event)!.add(listener as EventListener<keyof TransportEvents>);
      return transport;
    },
    ...
    off<E extends keyof TransportEvents>(
      ...
      eventListeners.get(event)?.delete(listener as EventListener<keyof TransportEvents>);
      return transport;
    },
  };
