...
async function processFile(filePath: string) {
	...
	// Clean up title - remove module prefixes like "@kundera-sn/kundera-ts"
	title = title.replace(/@kundera-sn\/kundera-ts/g, "").trim();
	title = title.replace(/@kundera-sn\/kundera-effect/g, "").trim();
