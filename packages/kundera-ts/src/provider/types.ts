 ...
 */
export interface ProviderEventMap extends Record<string, (...args: any[]) => void> {
...
export interface ProviderEvents {
  ...
  newHeads: (params?: NewHeadsSubscriptionParams) => AsyncGenerator<NewHead | ReorgData, void, unknown>;
  /** Subscribe to events */
  events: (params?: EventsSubscriptionParams) => AsyncGenerator<EmittedEvent | ReorgData, void, unknown>;
