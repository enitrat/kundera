...
import { MAX, MIN, SIZE, Uint128 } from "./index.js";
...
describe("Uint128", () => {
	...
	describe("from", () => {
		...
		it("should create from hex string", () => {
			...
			expect(Uint128.toBigInt(value)).toBe(
		...
		it("should create MAX - 1 value", () => {
			...
			expect(Uint128.toBigInt(value)).toBe(
				340282366920938463463374607431768211454n,
			);
		});
		...
		it("should throw on overflow", () => {
			expect(() =>
				Uint128.from(340282366920938463463374607431768211456n),
			).toThrow();
		});
