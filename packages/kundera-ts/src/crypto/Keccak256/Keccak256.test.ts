...
describe('Keccak256', () => {
  ...
  test('known vector - empty input', () => {
    ...
    const h = hashHex('');
    expect(h).toBe('0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470');
  });

  test('known vector - hello', () => {
    // keccak256("hello") = 0x1c8aff950685c2ed4bc3174f3472287b56d9517b9c948127319a09a7a36deac8
    const h = hashHex('hello');
    expect(h).toBe('0x1c8aff950685c2ed4bc3174f3472287b56d9517b9c948127319a09a7a36deac8');
  });

  test('known vector - bytes', () => {
    // keccak256([0x00])
    const h = hashHex(new Uint8Array([0]));
    expect(h).toBe('0xbc36789e7a1e281436464229828f817d6612f7b477d66591ff96a9e064bcc98a');
  });
