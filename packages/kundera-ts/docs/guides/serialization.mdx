...
```typescript
import { serializeU256, deserializeU256, serializeArray } from 'kundera-sn/serde';
...
| Scenario | Approach |
|----------|----------|
| Contract calls | Use `encodeCalldata` from `kundera-sn/abi` |
...
```typescript
import { serializeU256, deserializeU256 } from 'kundera-sn/serde';
...
```typescript
import { serializeU256 } from 'kundera-sn/serde';
import { Felt252 } from 'kundera-sn';
...
```typescript
import { serializeArray, deserializeArray } from 'kundera-sn/serde';
import { Felt252 } from 'kundera-sn';
...
```typescript
import { serializeByteArray } from 'kundera-sn/serde';
...
```typescript
import { deserializeU256, deserializeArray } from 'kundera-sn/serde';
...
```typescript
import { encodeCalldata } from 'kundera-sn/abi';
import { serializeU256 } from 'kundera-sn/serde';
import { Felt252 } from 'kundera-sn';
