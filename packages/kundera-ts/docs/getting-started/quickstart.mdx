...
Kundera uses [branded types](/getting-started/branded-types) to prevent mixing incompatible values:
...
<CardGroup cols={2}>
  ...
  <Card title="Agentic Coding" icon="robot" href="/getting-started/agentic-coding">
  ...
  <Card title="API Reference" icon="book" href="/api/primitives">
