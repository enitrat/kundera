...
// Connect — prompts the wallet popup
const accounts = await account.connect();
console.log('Connected:', accounts[0]);

// Execute a transaction — wallet signs + submits
...
// Switch network
await swo.request({ type: 'wallet_switchStarknetChain', params: { chainId: '0x534e5f4d41494e' } });

// Or use the builder + manual translation
