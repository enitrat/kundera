...
```typescript
import { ContractAddress, ClassHash } from 'kundera-sn';
...
**For production applications, we recommend [kundera-effect](/services)** — Effect-TS integration with typed errors, dependency injection, and composable operations.
...
[Get started with kundera-effect →](/services)
...
import { decodeOutputObject } from 'kundera-sn/abi';
