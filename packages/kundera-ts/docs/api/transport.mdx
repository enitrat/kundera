...
<Tip>
For most use cases, use [Providers](/api/provider) instead. Transports are for advanced scenarios requiring custom behavior or minimal overhead.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="HTTP Transport Skill" icon="network-wired" href="/skills/http-transport">
