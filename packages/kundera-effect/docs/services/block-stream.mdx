...
`BlockStreamService` streams Starknet blocks over polling or websocket modes with:
...
## Watch New Blocks Over WebSocket

```typescript
const websocketStream = blocks.watch({
  streamMode: "websocket",
  websocket: {
    url: "wss://api.cartridge.gg/x/starknet/sepolia",
  },
  fromBlock: 500_000,
  include: "header",
});
