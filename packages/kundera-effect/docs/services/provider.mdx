...
<Info>
These services mirror Voltaire’s Effect service architecture: small, composable layers with explicit dependencies.
</Info>
...
```ts
import { Effect } from "effect";
import { RpcError, TransportError } from "kundera-effect";
