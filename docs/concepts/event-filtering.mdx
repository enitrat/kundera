...
Kundera provides ABI-aware filtering:
...
For RPC queries, compile your filter and pass to the RPC call:
...
<CardGroup cols={2}>
  ...
  <Card title="Event Listening" icon="rss" href="/recipes/event-listening">
