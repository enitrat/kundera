...
```typescript
import { serializeU256, deserializeU256, serializeArray } from '@kundera-sn/kundera-ts/serde';
...
| Scenario | Approach |
|----------|----------|
| Contract calls | Use `encodeCalldata` from `@kundera-sn/kundera-ts/abi` |
...
```typescript
import { serializeU256, deserializeU256 } from '@kundera-sn/kundera-ts/serde';
...
```typescript
import { serializeU256 } from '@kundera-sn/kundera-ts/serde';
import { Felt252 } from '@kundera-sn/kundera-ts';
...
```typescript
import { serializeArray, deserializeArray } from '@kundera-sn/kundera-ts/serde';
import { Felt252 } from '@kundera-sn/kundera-ts';
...
```typescript
import { serializeByteArray } from '@kundera-sn/kundera-ts/serde';
...
```typescript
import { serializeArray, serializeU256 } from '@kundera-sn/kundera-ts/serde';
import { Felt252 } from '@kundera-sn/kundera-ts';
...
```typescript
import { deserializeU256, deserializeArray } from '@kundera-sn/kundera-ts/serde';
...
<CardGroup cols={2}>
  <Card title="Serde API" icon="code" href="/typescript/api/serde">
    Complete serde API reference.
  </Card>
  <Card title="ABI Encoding" icon="brackets-curly" href="/typescript/guides/abi/encode-decode">
    High-level calldata encoding.
  </Card>
  <Card title="Cairo Types" icon="cube" href="/typescript/api/serde">
