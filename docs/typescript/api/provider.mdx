...
<Tip>
Looking for copy-paste implementations? See [HTTP Provider Skill](/typescript/skills/http-provider) and [WebSocket Provider Skill](/typescript/skills/websocket-provider) for customizable provider implementations.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="HTTP Provider Skill" icon="plug" href="/typescript/skills/http-provider">
