...
|----------|-----------------|
| Contract calls | `encodeCalldata` from `@kundera-sn/kundera-ts/abi` |
...
```typescript
import { serializeU256, serializeArray } from '@kundera-sn/kundera-ts/serde';
...
<CardGroup cols={2}>
  <Card title="ABI Encoding" icon="code" href="/typescript/guides/abi/encode-decode">
