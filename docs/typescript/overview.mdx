...
**For production applications, we recommend [@kundera-sn/kundera-effect](effect/services)** — Effect-TS integration with typed errors, dependency injection, and composable operations.
...
[Get started with @kundera-sn/kundera-effect →](effect/services)
