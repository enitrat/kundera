...
| **Type Safety** | Branded types (ContractAddress ≠ ClassHash) | Plain strings |
...
**For production applications, we recommend [@kundera-sn/kundera-effect](/typescript/services)** — Effect-TS integration with typed errors, dependency injection, and composable operations.
...
[Get started with @kundera-sn/kundera-effect →](/typescript/services)
