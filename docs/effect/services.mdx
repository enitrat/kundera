...
@kundera-sn/kundera-effect exposes a minimal services layer similar to Voltaire’s DI model.
...
- `ContractFactory`: Voltaire-style typed contract instance (`read`/`write`/`simulate`)
