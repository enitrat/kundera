...
export interface HttpRequestOptions extends TransportRequestOptions {
...
export interface HttpTransport extends Transport {
  request<T>(request: JsonRpcRequest, options?: HttpRequestOptions): Promise<JsonRpcResponse<T>>;
  requestBatch<T>(requests: JsonRpcRequest[], options?: HttpRequestOptions): Promise<JsonRpcResponse<T>[]>;
}
